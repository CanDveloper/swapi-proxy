...
public class JsonMapper {
	...
	public PersonDto JsonToPersonDtoMapper(String jsonString) throws IOException{
	...
	private ArrayList<FilmDto> GetFilmograpy(ArrayList<Integer> filmIdList) throws JsonMappingException, JsonProcessingException {
	...
	private Vehicle GetFastestVehicle(ArrayList<Integer> vehicleIdList) throws JsonMappingException, JsonProcessingException {
		...
		for (Integer vehicleId : vehicleIdList) {
			...
			vehicle.setMax_atmosphering_speed(GetIdentifier(jsonTreeVehicleObject.path("max_atmosphering_speed").asText()));
	...
	private Starship GetFastestStarship(ArrayList<Integer> starshipIdList) throws JsonMappingException, JsonProcessingException {
		...
		for (Integer starshipId : starshipIdList) {
			...
			starship.setMax_atmosphering_speed(GetIdentifier(jsonTreeStarshipObject.path("max_atmosphering_speed").asText()));
